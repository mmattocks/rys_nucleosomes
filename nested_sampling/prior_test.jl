...
#code_binary = "/bench/PhD/NGS_binaries/BMI/coded_obs_set"
#matrix_output = "/bench/PhD/NGS_binaries/BMI/BGHMM_sib_matrix"
...
isfile(string(sib_e_ui_pth,'/',"ens")) ? (sib_e_ui = deserialize(string(sib_e_ui_pth,'/',"ens"))) :
    (sib_e_ui = BioMotifInference.IPM_ensemble(worker_pool, sib_e_ui_pth, ensemble_size, sib_ui_sp, (falses(0,0), mixing_prior), sib_matrix, sib_obs, source_length_range))
...
isfile(string(sib_e_inf_pth,'/',"ens")) ? (sib_e_inf = deserialize(string(sib_e_inf_pth,'/',"ens"))) :
        (sib_e_inf = BioMotifInference.IPM_ensemble(worker_pool, sib_e_inf_pth, ensemble_size, sib_inf_sp, (falses(0,0), mixing_prior), sib_matrix, sib_obs, source_length_range))
...
isfile(string(rys_e_ui_pth,'/',"ens")) ? (rys_e_ui = deserialize(string(rys_e_ui_pth,'/',"ens"))) :
    (rys_e_ui = BioMotifInference.IPM_ensemble(worker_pool, rys_e_ui_pth, ensemble_size, rys_ui_sp, (falses(0,0), mixing_prior), rys_matrix, rys_obs, source_length_range))
...
isfile(string(rys_e_inf_pth,'/',"ens")) ? (rys_e_inf = deserialize(string(rys_e_inf_pth,'/',"ens"))) :
        (rys_e_inf = BioMotifInference.IPM_ensemble(worker_pool, rys_e_inf_pth, ensemble_size, rys_inf_sp, (falses(0,0), mixing_prior), rys_matrix, rys_obs, source_length_range))
...
isfile(string(combined_e_ui_pth,'/',"ens")) ? (combined_e_ui = deserialize(string(combined_e_ui_pth,'/',"ens"))) :
    (combined_e_ui = BioMotifInference.IPM_ensemble(worker_pool, combined_e_ui_pth, ensemble_size, combined_ui_sp, (falses(0,0), mixing_prior), combined_matrix, combined_obs, source_length_range))
...
isfile(string(combined_e_inf_pth,'/',"ens")) ? (combined_e_inf = deserialize(string(combined_e_inf_pth,'/',"ens"))) :
        (combined_e_inf = BioMotifInference.IPM_ensemble(worker_pool, combined_e_inf_pth, ensemble_size, combined_inf_sp, (falses(0,0), mixing_prior), combined_matrix, combined_obs, source_length_range))
